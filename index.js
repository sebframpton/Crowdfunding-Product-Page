...
const bookmarkContainer = document.querySelector('product-title-bookmark-container');
const bookmarkedContainer = document.querySelector('.product-title-bookmarked-container');
...
function unbookmark() {
    bookmarkedIcon.addEventListener("click",()=> {
        ...
        bookmarkedContainer.classList.remove("bookmarked");
